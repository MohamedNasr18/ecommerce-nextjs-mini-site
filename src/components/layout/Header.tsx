    ...
    <header className="sticky top-0 z-50 bg-white border-b border-slate-100 shadow-sm">
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
        <div className="flex items-center justify-between h-14 sm:h-16 gap-1 sm:gap-4">
          ...
          >
            <svg width="90" height="14" viewBox="0 0 159 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="sm:w-[120px] sm:h-[18px] md:w-[159px] md:h-[24px]">
          ...
          {/* Right side actions */}
          <div className="flex items-center gap-0 sm:gap-0.5 md:gap-2">

            {/* Language switcher - Hidden on mobile */}
            <div className="hidden sm:flex items-center border border-slate-200 rounded-full overflow-hidden text-xs font-semibold">
              <button
            ...
            <Link
              ...
              className="relative p-1 sm:p-1.5 md:p-2 text-slate-600 hover:text-indigo-600 transition-colors rounded-full hover:bg-slate-50"
              aria-label={`${t('nav.wishlist')} (${wishlistCount})`}
            >
              <Heart size={16} className="sm:w-[18px] sm:h-[18px] md:w-[20px] md:h-[20px]" />
              {wishlistCount > 0 && (
            ...
            >
              <ShoppingCart size={16} className="sm:w-[18px] sm:h-[18px] md:w-[20px] md:h-[20px]" />
              {cartCount > 0 && (
            ...
            <button
              ...
              className="md:hidden p-1 sm:p-1.5 text-slate-600 hover:text-slate-900 transition-colors rounded-full hover:bg-slate-50"
        ...
        <div className="md:hidden border-t border-slate-100 bg-white" role="navigation" aria-label="Mobile navigation">
          <div className="px-4 py-3 space-y-1">
            ...
            <div className="pt-2 border-t border-slate-100">
              <p className="px-3 py-1 text-xs font-semibold text-slate-400 uppercase tracking-wide">{t('nav.language')}</p>
              <div className="flex gap-1 px-3 py-2">
                <button
                  ...
                  className={`flex-1 px-3 py-2 text-xs font-semibold rounded-lg transition-colors ${
                    locale === 'en' ? 'bg-indigo-600 text-white' : 'bg-slate-100 text-slate-600 hover:bg-slate-200'
                  }`}
                >
                  English
                </button>
                <button
                  ...
                  className={`flex-1 px-3 py-2 text-xs font-semibold rounded-lg transition-colors ${
                    locale === 'ar' ? 'bg-indigo-600 text-white' : 'bg-slate-100 text-slate-600 hover:bg-slate-200'
                  }`}
                >
                  العربية
                </button>
